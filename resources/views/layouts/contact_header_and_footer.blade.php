                        ...
                        <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="topbar-info">
                                            ...
                                            <span>/</span>
                                            <a href="mailto:info@sunnahislammedia.com"><i
                                                    class="fa fa-envelope"></i>info@sunnahislammedia.com</a>
                                        </div>
                                    </div>
                            ...
                            <div class="navbar-collapse hidden-sm hidden-xs">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle disabled"
                                            href="{{ route('Ugandan-Sheikhs') }}">Audios</a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle disabled"
                                            href="{{ route('All-videos') }}">Videos</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="{{ route('All-videos') }}">Ugandan Sheikhs</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle disabled"
                                            href="{{ route('morning-adhkar') }}">dua & Adhkar</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="{{ route('morning-adhkar') }}">Morning Adhkar</a></li>
                                            <li><a href="{{ route('evening-adhkar') }}">Evening Adhkar</a></li>
                                            <!--<li><a href="{{ route('Adhkar-After-Swalah') }}">Adhkar after swalah</a>-->
                                            <!--</li>-->
                                            <!--<li><a href="{{ route('Famous-Duas-from-the-Quran') }}">Famous Duas from-->
                                            <!--        the Quran</a></li>-->
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a id="links-highlight" href="{{ route('All_Arabic_Books') }}">Arabic
                                                Books</a></li>
                                        <li><a id="links-highlight" href="{{ route('All_English_Books') }}">English
                                                Books</a></li>
                                        <li><a id="links-highlight" href="{{ route('All_Luganda_Books') }}">Luganda
                                                Books</a></li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a id="links-highlight" href="{{ route('Ugandan-Sheikhs') }}">Ugandan
                                                Sheikhs</a></li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a id="links-highlight" href="{{ route('All-videos') }}">Ugandan
                                                Sheikhs</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                                    ...
                                    <ul aria-expanded="false">
                                        ...
                                        <li><a id="links-highlight" href="{{ route('morning-adhkar') }}">Morning
                                                Adkar</a></li>
                                        <li><a id="links-highlight" href="{{ route('evening-adhkar') }}">Evening
                                                Adkar</a></li>
                                        <li><a id="links-highlight" href="{{ route('Adhkar-After-Swalah') }}">Adhkar
                                                after swalah</a></li>
                                        <li><a id="links-highlight"
                                                href="{{ route('Famous-Duas-from-the-Quran') }}">Famous Duas from the
                                                Quran</a></li>
                                        <li><a id="links-highlight" href="{{ route('Other-Duas') }}">Other Dua's</a>
                                        </li>
    ...
    <section class="page-banner services-banner">
        <div class="container">
            <div class="banner-header">
                ...
                <p class="lead" style="color: white">Incase of any advice, complaint, request etc... please contact
                    us , we shall respond immediately, insha'Allah</p>
                                    ...
                                    <div class="filter-box">
                                        ...
                                        <form action="{{ route('search-bar') }}" method="get">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="form-group">
                                                    <select class="form-control" name="Catagory1"
                                                        value="{{ old('Catagory') }}">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="form-group">
                                                    <select class="form-control" name="Catagory2"
                                                        value="{{ old('Catagory') }}">
                                                        <option value="">CATAGORY</option>
                                                        <option value="AQEEDAH">AQEEDAH</option>
                                                        <option value="SHIRK">SHIRK</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-6 widget-container">
                                                <div id="text-2" class="widget widget_text">
                                                    <h3 class="footer-widget-title">About &nbsp; Salfah Islam Media 
                                                    </h3>
                                                    <span class="underline left"></span>
                                                    <div class="textwidget" style="text-align: justify">
                                                        We ask your Du’a for the Ulama, Scholars, Students of Knowledge,
                                                        Authors and Speakers whose works have been posted on this
                                                        website, and for us. May Allah سُبْحَانَهُۥ وَتَعَالَىٰ make
                                                        this website beneficial for all. </div>
                                                    <address>
                                                        <div class="info">
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <span><a
                                                                    href="mailto:info@sunnahislammedia.com">info@sunnahislammedia.com</a></span>
                                                        </div>
                                                        <div class="info">
                                                ...
                                                <div id="nav_menu-2" class="widget widget_nav_menu">
                                                    ...
                                                    <div class="menu-quick-links-container">
                                                        <ul id="menu-quick-links" class="menu">
                                                            ...
                                                            <li><a href="{{ 'morning-adhkar' }}">Dua & Adhkar</a>
                                                            </li>
                                                            <li><a href="{{ route('about-us') }}">About us</a></li>
                                            ...
                                            <div class="clearfix hidden-lg hidden-md hidden-xs tablet-margin-bottom">
                                            </div>
                                            <div class="col-md-2 col-sm-6 widget-container">
                                                ...
                                                <div class="widget twitter-widget">
                                                    ...
                                                    <div id="twitter-feed">
                                                        <ul>
                                                            ...
                                                            <p style="text-align: justify">“The life of this world is
                                                                made up of three days: yesterday has gone with all that
                                                                was done; tomorrow, you may never reach; but today is
                                                                for you so do what you should do today.” <br> <b> Imaam
                                                                    Hasan Al Basri</b></p>
                                                            <br>
                                                            <p style="font-size: 1.5em">اَلسَّلاَ مُ عَلَيْكُمْ
                                                                وَرَحْمَةُ اللهِ وَبَرَكَا تُهُ</p>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
